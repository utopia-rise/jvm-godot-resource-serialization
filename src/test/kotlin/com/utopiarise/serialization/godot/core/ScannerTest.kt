...
class ScannerTest {
    ...
    @Test
    fun `scene TestScene has 97 tokens when scanned`() = assertEquals(97, sceneTokens.size)
    ...
    @Test
    fun `scene TestScene has 2 NodeTokens when scanned`() = assertEquals(2, sceneTokens.filterIsInstance<NodeToken>().size)
