...
class ScriptDeclaration(token: ScriptToken, callExternalResourceDeclaration: CallExternalResourceDeclaration)
    : Declaration(token, callExternalResourceDeclaration)