                    ...
                    all {
                        if (this is MavenPublication) {
                            ...
                            pom {
                                ...
                                scm {
                                    connection.set("scm:git:https://github.com/utopia-rise/jvm-godot-resource-serialization")
                                    developerConnection.set("scm:git:github.com:utopia-rise/jvm-godot-resource-serialization.git")
                                    tag.set("master") //FIXME
                                    url.set("https://github.com/utopia-rise/jvm-godot-resource-serialization")
                                }

                                licenses {
                                    license {
                                        name.set("MIT License")
                                        url.set("https://github.com/utopia-rise/jvm-godot-resource-serialization/blob/master/LICENSE")
